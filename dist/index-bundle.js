...
var closeMenu = document.querySelector('.burger-close');
var items = document.querySelectorAll('.burger-menu__item');
...
if (document.querySelector('.marketing') || document.querySelector('.training')) {
  ...
  var modalSubmit = document.querySelector('.marketing-btn');
  var nameV = document.querySelector('.marketing-name');
  var emailV = document.querySelector('.marketing-email');
  var nameT = document.querySelector('.marketing-warning-name');
  var emailT = document.querySelector('.marketing-warning-email'); // const success = document.querySelector('.modal-success')
...
if (document.querySelector('.intro')) {
  ...
  var nameV = document.querySelector('.modal-name');
  var emailV = document.querySelector('.modal-email');
  var textV = document.querySelector('.modal-text');
  var nameT = document.querySelector('.modal-warning-name');
  var emailT = document.querySelector('.modal-warning-email');
  var textT = document.querySelector('.modal-warning-text');
...
(() => {
"use strict";
/* harmony import */ var _js_burger_menu_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(2255);
/* harmony import */ var _js_burger_menu_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_js_burger_menu_js__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _js_modal_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(6862);
...
/* harmony import */ var _js_form_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(1289);
